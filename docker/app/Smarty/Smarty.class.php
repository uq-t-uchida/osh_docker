...
if (!defined('SMARTY_EXTEND_DIR')) {
	define('SMARTY_EXTEND_DIR', dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . 'Smarty_ext' . DIRECTORY_SEPARATOR);
}
...
if (!defined('SMARTY_EXTEND_PLUGINS_DIR')) {
	define('SMARTY_EXTEND_PLUGINS_DIR', SMARTY_EXTEND_DIR . 'plugins');
}
...
class Smarty
{
     ...
     * @var array
     */
    var $plugins_dir     =  array('plugins', SMARTY_EXTEND_PLUGINS_DIR);
